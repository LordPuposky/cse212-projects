...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: None. The logic for finite positive turns works as expected.
    ...
    // Defect(s) Found: None. New people are added to the back of the queue correctly.
    ...
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found:
    // Defect(s) Found: People with infinite turns (0) were not being re-enqueued. Fixed by adding a check for turns <= 0.
    ...
    // Defect(s) Found:
    // Defect(s) Found: Negative turns were treated as finite and not re-enqueued. Fixed to treat <= 0 as infinite.
    ...
    // Defect(s) Found:
    // Defect(s) Found: None. The exception is thrown correctly.
